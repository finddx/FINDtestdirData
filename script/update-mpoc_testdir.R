...
sf_data <- readr::read_csv("https://raw.githubusercontent.com/finddx/FINDtestdirData/report/mpoc_testdir.csv")
...
meta_cols <-
  readr::read_csv("data/mpoc/mpoc_testdir_meta_cols.csv", show_col_types = FALSE) |>
...
write_csv(geo_data, "data/mpoc/mpoc_testdir.csv")
